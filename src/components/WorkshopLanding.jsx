...
import { Globe, Sparkles, CheckCircle2, ArrowRight, Play, Zap, Bot, Database, X } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full mt-10">
        ...
        >
          ...
          <p className="text-neutral-500 text-lg md:text-xl font-medium max-w-2xl mx-auto leading-relaxed">
            Most courses show slides. We build 5+ industry-grade AI agents live — sales, support, content, and automation.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl p-6 md:p-8 border border-neutral-200 shadow-xl flex flex-col gap-6">
              <BenefitItem><strong>LinkedIn Content Agent:</strong> Auto-research, write & post.</BenefitItem>
              <BenefitItem><strong>WhatsApp Sales Bot:</strong> Qualifies & closes leads.</BenefitItem>
              <BenefitItem><strong>AI Voice Caller:</strong> Vapi-powered human-like calls.</BenefitItem>
              <BenefitItem border={false}><strong>Agency Blueprint:</strong> Sell agents for ₹50k+.</BenefitItem>

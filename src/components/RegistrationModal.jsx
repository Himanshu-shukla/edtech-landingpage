      ...
      <div className="relative w-full max-w-md animate-modal">
        <div className="glass-modal rounded-3xl shadow-2xl overflow-hidden text-white">
          ...
          <div className="px-8 pt-10 pb-8">
            <h2 className="text-3xl font-bold mb-2 font-serif" style={{ fontFamily: 'Playfair Display' }}>
              Reserve Your Spot
            </h2>
            <p className="text-white/60 text-sm mb-8 font-sans">
              Complete your registration for the 2-Day Bootcamp.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="flex gap-2">
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center gap-2 h-[48px] px-3 bg-white/5 border border-white/10 rounded-xl hover:bg-white/10 transition-all"
                    >
                    ...
                    {showCountryDropdown && (
                      <div className="absolute top-full left-0 mt-2 w-56 bg-slate-900 border border-white/10 rounded-xl shadow-2xl z-50 max-h-60 overflow-y-auto">
                        {countries.map((c) => (
                          <div
                            key={c.code}
                  ...
                  <input
                    ...
                    className="flex-1 bg-white/5 border border-white/10 rounded-xl px-4 py-3 outline-none focus:border-emerald-500/50 transition-all"
              ...
              <button
                ...
                className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-4 rounded-xl shadow-lg shadow-emerald-900/20 transition-all flex items-center justify-center gap-2 mt-4"
              >
                {isSubmitted ? (

...
const WhyAgenticAI = () => {
  return (
    // Changed bg-neutral-950 to bg-neutral-50 (off-white)
    <section className="relative w-full bg-neutral-50 py-12 md:py-24 px-4 flex justify-center overflow-hidden font-sans border-t border-neutral-100">
      ...
      {/* Light Blueprint Grid & Glow - Adjusted for light mode contrast */}
      ...
      {/* Main Container - Switched to white glassmorphism */}
      <motion.div 
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 w-full">
            ...
            <SpotlightCard 
              ...
              text={
                <>
                  <span className="text-neutral-900 font-bold">Builds, Not Slides:</span> Stop watching scattered YouTube tutorials. We build <span className="text-neutral-900 font-bold">5+ working agents live</span> in class that you can deploy immediately.
                </>
              }
            />
            ...
            <SpotlightCard 
              ...
              text={
                <>
                  <span className="text-neutral-900 font-bold">Save 30+ Hours/Week:</span> Automate your daily office grunt work. From emails to reports, learn to delegate manual tasks to <span className="text-neutral-900 font-bold">AI Agents</span> forever.
                </>
              }
            />
            ...
            <SpotlightCard 
              ...
              text={
                <>
                  <span className="text-neutral-900 font-bold">Agency Blueprint:</span> Don't just learn skills, learn to sell them. Get our roadmap to launch a <span className="text-neutral-900 font-bold">1-Person AI Agency</span> and charge ₹50k+ per client.
                </>
              }
            />
...
const SpotlightCard = ({ icon, text, number, delay }) => {
  ...
  return (
    ...
    >
      ...
      />
      {/* Number: Changed to light neutral shade */}

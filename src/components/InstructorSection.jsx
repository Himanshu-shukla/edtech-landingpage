...
import { Check, Sparkles, Award, Terminal, Zap, ShieldCheck } from 'lucide-react';
...
const InstructorSection = () => {
  return (
    <section className="relative py-24 px-4 bg-neutral-950 font-sans overflow-hidden">
      ...
      {/* Glowing Spotlights - Swapped to Emerald/Teal to match Agency vibe */}
      ...
      <div className="max-w-5xl mx-auto relative z-10 flex flex-col items-center">
        ...
        >
          ...
          <p className="relative font-bold text-sm md:text-base leading-tight text-center flex items-center gap-2">
            ...
            <span>Master the same Agentic Systems that <span className="text-yellow-300 underline underline-offset-4 decoration-yellow-300/50">Save Enterprises Millions.</span></span>
          </p>
        </motion.div>
              ...
              <div className="relative w-64 h-80 md:w-80 md:h-[400px] rounded-2xl overflow-hidden border border-neutral-700 bg-neutral-900 shadow-2xl">
                ...
                <div className="absolute bottom-4 left-4 right-4 bg-neutral-900/80 backdrop-blur-md border border-neutral-700/50 rounded-xl p-3 flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-white">Agentic Workflows</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex-1 text-left">
              ...
              >
                ...
                <p className="text-emerald-400/90 text-sm md:text-base font-medium mb-8 border-l-2 border-emerald-500 pl-4 tracking-wide">
                  Enterprise AI Strategist | Architect of Nugget (Zomato Partner) | Serial Automation Founder
                </p>
              </motion.div>
              ...
              <ul className="space-y-4">
                <ListItem delay={0.1}>
                  Deployed Agentic AI Solutions reducing support costs by <span className="text-emerald-400 font-semibold">$10 Million+ for industry leaders.</span>
                </ListItem>
                
                <ListItem delay={0.2}>
                  Visionary behind <span className="text-emerald-400 font-semibold">Nugget AI</span>—the modular toolkit for omnichannel enterprise automation.
                </ListItem>
                
                <ListItem delay={0.3}>
                  Honored as <span className="text-emerald-400 font-semibold">AI Entrepreneur of the Year</span> & recognized by NASSCOM's Top 50 Emerging IT.
                </ListItem>
                
                <ListItem delay={0.4}>
                  Teaching the exact <span className="text-emerald-400 font-semibold">Production-Ready Frameworks</span> used to build and sell Agentic AI Services.
                </ListItem>
              </ul>

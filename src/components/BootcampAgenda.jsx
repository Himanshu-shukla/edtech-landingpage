...
const BootcampAgenda = () => {
    ...
    return (
        <section className="relative py-12 px-4 bg-neutral-950 font-sans overflow-hidden">
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
                    ...
                    >
                        {/* Image Container */}
                        <div className="relative group rounded-3xl overflow-hidden border-2 border-neutral-800 shadow-2xl">
                            <div className="absolute inset-0 bg-gradient-to-t from-neutral-950 via-transparent to-transparent z-10"></div>
                            {/* Replace with your actual instructor image */}
                            <img
                            ...
                            <div className="absolute bottom-6 left-6 z-20">
                                <span className="bg-emerald-600 text-white px-3 py-1 rounded text-xs font-bold uppercase tracking-wider">
                                    Lead Instructor
                                </span>
                                <h3 className="text-white text-2xl font-black mt-2">Pritam Nagrale</h3>
                                <p className="text-neutral-300 text-sm">Founder, EdTech Informative</p>
                            </div>
                        </div>

                        {/* Logistics Cards */}
                        <div className="grid grid-cols-2 gap-4">
                            <div className="bg-neutral-900 border border-neutral-800 p-4 rounded-xl flex flex-col items-center text-center">
                                <Calendar className="w-6 h-6 text-emerald-400 mb-2" />
                                <span className="text-white font-bold text-sm">25 - 26 Oct 2025</span>
                                <span className="text-neutral-500 text-xs uppercase">Date</span>
                            </div>
                            <div className="bg-neutral-900 border border-neutral-800 p-4 rounded-xl flex flex-col items-center text-center">
                                <Clock className="w-6 h-6 text-emerald-400 mb-2" />
                                <span className="text-white font-bold text-sm">11 AM BST</span>
                                <span className="text-neutral-500 text-xs uppercase">Time</span>
                            </div>
                            <div className="bg-neutral-900 border border-neutral-800 p-4 rounded-xl flex flex-col items-center text-center">
                                <Video className="w-6 h-6 text-emerald-400 mb-2" />
                                <span className="text-white font-bold text-sm">100% Practical</span>
                                <span className="text-neutral-500 text-xs uppercase">Training</span>
                            </div>
                            <div className="bg-neutral-900 border border-neutral-800 p-4 rounded-xl flex flex-col items-center text-center">
                                <MessageCircle className="w-6 h-6 text-emerald-400 mb-2" />
                                <span className="text-white font-bold text-sm">Real-Time QA</span>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: true }}
                        className="bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden shadow-[0_0_50px_rgba(124,58,237,0.15)] group"
                    >
                        {/* Animated Purple Accent Top */}
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-1.5 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-b-full shadow-[0_0_20px_rgba(124,58,237,0.8)]"></div>
                        ...
                        <div className="space-y-4 relative z-10">
                            {[
                                ...
                                "Develop Easy & Practical Data Analysis Skills (Perfect For Beginners)",
                                ...
                                <motion.div
                                    ...
                                    className="flex gap-5 items-start p-4 rounded-2xl border border-transparent hover:border-purple-500/30 transition-all duration-300 cursor-default"
                                >
                                    <div className="mt-1 flex-shrink-0">
                                        <div className="bg-purple-500/10 border border-purple-500/20 rounded-full p-1.5 shadow-[0_0_15px_rgba(168,85,247,0.2)] group-hover:shadow-[0_0_25px_rgba(168,85,247,0.4)] transition-all">
                                            <CheckCircle2 className="w-5 h-5 text-purple-400" strokeWidth={3} />
                                        </div>
                                    </div>
                                    <p className="text-neutral-300 font-medium text-base md:text-lg leading-snug group-hover:text-white transition-colors">
                                        {item}
                                    </p>
                                </motion.div>
                            ))}
                        ...
                        <div className="absolute -top-20 -right-20 w-64 h-64 bg-purple-900/20 rounded-full blur-[100px] pointer-events-none"></div>
                        <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-indigo-900/20 rounded-full blur-[100px] pointer-events-none"></div>
                    </motion.div>

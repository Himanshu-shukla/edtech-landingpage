...
import { CheckCircle2, Calendar, Clock, Video, MessageCircle, X } from 'lucide-react';
            ...
            <div className="max-w-6xl mx-auto pt-6">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                { icon: Video, text: "100% Practical", label: "Training" },
                                { icon: MessageCircle, text: "Real-Time QA", label: "Support" },
                            ].map((item, idx) => (
                                <div key={idx} className="bg-white border border-neutral-200 p-4 rounded-xl flex flex-col items-center text-center shadow-sm">
                ...
                >
                    ...
                    >
                        ...
                        />
                        <span className="relative z-10">Register For £99</span>
